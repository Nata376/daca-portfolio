...
SELECT customer_id, total_price, sale_date, channel
FROM sales
...
SELECT 
    COUNT(*) AS kokku,
    COUNT(DISTINCT category) AS "Unikaalsete kategooriate arv",
    COUNT(*) - COUNT(retail_price) AS puuduvaid_hinnad
FROM products;
...
SELECT 
    COUNT(*) AS tellimusi_kokku,
    COUNT(*) - COUNT(customer_id) AS puuduvate_customer_id_arv
FROM sales;
